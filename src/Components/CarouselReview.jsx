...
export default function CarouselReview() {
  ...
  const top = useBreakpointValue({ base: "96%", md: "60%" });
    ...
    >
      ...
      <Slider {...settings} ref={(slider) => setSlider(slider)} >
        {cards.map((card, index) => (
          <Box
            key={index}
            height={{ xl: "auto", md: "536px" , base:"434px"}}
            position="relative"
          ...
          >
            ...
            >
              ...
              >
                ...
                <Text fontSize={{ lg: "lg" , base:"14px"}} color="black">
                  {card.name}
                </Text>
              </Flex>
              <Box
                ...
                position="absolute"
                top="28%"
                w={{ xl: "90%", md: "90%" , base:"80%" }}
              >
                <Text fontSize={{base:"12px", md:"14px", xl:"16px"}} color="#717171">
                  {card?.text}
                </Text>
              </Box>
            </Box>

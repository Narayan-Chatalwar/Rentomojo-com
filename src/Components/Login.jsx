...
import {
  ...
  //console.log(finalOtp)
   ...
   const handleLogout = () => {
    ...
    return (
      <>
        <Button id="top" onClick={onOpen} style={{backgroundColor:"#dc3226",color:"white"}} display={{base:"none",md:"inline-flex",lg:"inline-flex"}} padding="20px">Login/SignUp</Button>
        <Button id="top" onClick={onOpen} style={{backgroundColor:"#dc3226",color:"white"}} display={{base:"inline-flex",md:"none",lg:"none"}} padding="10px"><BsPersonFill/></Button>

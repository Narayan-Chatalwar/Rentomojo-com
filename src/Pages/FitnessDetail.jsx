  ...
  return (
    <div>
      ...
      <Box className="App" position="relative">
        <ButtonSection price={currentFitness.price} handleCart={handleCart} toast={toast} />
        <Box
            ...
            >
              ...
              <Box border="1px solid #e9e9e9 ">
                ...
                >
                  ...
                  <Flex display={{ base: "block", md: "block", xl: "none" }}>
                    <Text>&#8377; {Number(currentFitness.price) + 150}/mo</Text>
                ...
                <Flex>
                  ...
                  >
                    ...
                    <Text mb="20px">
                      ...
                      smart brains, this {currentFitness.category} effortlessly
                      reduces the cost of electricity. It reduces your efforts
                      and makes your life easy and entertaining. With
                      best-in-class features, corral your way to your favorite
                      work.
                    </Text>
                  ...
                  <Button
                    ...
                    onClick={() => (
                      toast({
                        title: "Item added.",
                        position: "top-right",
                        description: "This item added to cart.",
                        status: "success",
                        duration: 3000,
                        isClosable: true,
                      }),
